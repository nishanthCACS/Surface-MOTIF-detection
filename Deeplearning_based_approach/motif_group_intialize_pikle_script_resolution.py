...
id_string = pickle.load(open( "id_ongo.p", "rb" ))
res =pickle.load(open( "res_ongo.p", "rb" ))    

#%% to run the script
working_dir = "C:/Users/nishy/Documents/Projects_UL/mot_if_STUDY/onco_started"
saving_dir = "C:/Users/nishy/Documents/Projects_UL/mot_if_STUDY/onco_started/finalised_pikle_results_groups/resolution_dip_ongo_results"
os.chdir('/')
